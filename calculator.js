...
function calculator(button){
     if(button.type == "operator"){
        ...
        //FIXING POWER AND FACTORIAL FUNCTIONS
        //SEARCH FOR FACTORIAL AND POWER FUNCTIONS
        let POWER_SEARCH_RESULT = search(data.formula, POWER);
        let FACTORIAL_SEARCH_RESULT = search(data.formula, FACTORIAL);

        //GET POWER BASE AND REPLACE THEM WITH THE RIGHT FORMULA
        ...
        ////GET FACTORIAL NUMBER AND REPLACE THEM WITH THE RIGHT FORMULA
...
function factorialNumberGetter(formula, FACTORIAL_SEARCH_RESULT){
    ...
    let replacement = factorial.repeat(times) + number_str + close_parenthesis;
...
https://www.youtube.com/watch?v=52GL_cfLBYs&t=291s
https://code-projects.org/scientific-calculator-in-javascript-with-source-code/
